  ...
  return (
    <>
      <PageHeader
        ...
        title="App"
        description="Analytics from the Supplements app mobile app: signups, subscription revenue, who's paying and who stopped, plus app users matched to store customers so affiliates get credited."
      />
