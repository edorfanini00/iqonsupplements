import { deleteExpense } from "@/lib/accounting/store";
...
export async function DELETE(
  ...
  try {
    ...
    if (!ok) return apiError("NOT_FOUND", "Expense not found.", 404);
    ...
    console.error("[api/affiliates/admin/accounting/expenses/:id DELETE]", err);
    return apiError("INTERNAL", "Failed to delete expense.", 500);
  }
}
