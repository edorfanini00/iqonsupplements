import { deletePurchase } from "@/lib/accounting/store";
...
export async function DELETE(
  ...
  try {
    ...
    if (!ok) return apiError("NOT_FOUND", "Purchase not found.", 404);
    ...
    console.error("[api/affiliates/admin/accounting/purchases/:id DELETE]", err);
    return apiError("INTERNAL", "Failed to delete purchase.", 500);
  }
}
