import { deleteManualSale } from "@/lib/accounting/store";
...
export async function DELETE(
  ...
  try {
    ...
    if (!ok) return apiError("NOT_FOUND", "Sale not found.", 404);
    ...
    console.error("[api/affiliates/admin/accounting/sales/:id DELETE]", err);
    return apiError("INTERNAL", "Failed to delete sale.", 500);
  }
}
