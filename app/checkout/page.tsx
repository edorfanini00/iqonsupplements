...
export default function CheckoutPage(){
  ...
  return <main id="main">
    <div className="checkout-heading section-pad"><h1>Your selection.</h1><p>{live?"Review your essentials before continuing to secure checkout.":"Checkout preview · Sample products and prices. No order will be placed."}</p></div>
    ...
    {!ready?<p className="section-pad" role="status">Loading your bag…</p>:cart.length?<div className="checkout-layout section-pad">
      ...
      <aside className="checkout-summary"><h2>Order summary</h2><dl>
        ...
        <div><dt>{live?"Subtotal":"Sample subtotal"}</dt><dd>{money(subtotal,currency)}</dd></div>
