...
export function HumanStory({skincare=false,compact=false,movement=false}:{skincare?:boolean;compact?:boolean;movement?:boolean}) {
  return <section className={`human-story ${skincare?"human-story-skin":""} ${compact?"human-story-compact":""}`}>
    <div className="human-story-image"><img src={skincare?"/images/editorial/skin-ritual.webp":movement?"/images/editorial/iqon-pilates-editorial.webp":"/images/editorial/everyday-movement.webp"} alt={skincare?"A woman taking a moment for her skincare routine":movement?"A woman tying her shoes before Pilates":"Two adults talking during a coastal walk"} width={skincare?1200:1800} height={skincare?1500:1200} loading="lazy"/></div>
