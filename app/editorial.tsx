...
export function JournalPreview({skincare=false}:{skincare?:boolean}) {
 const skincareImages:Record<string,{image:string;imageAlt:string}>={
  "a-simple-skincare-routine":{image:"/images/editorial/skincare-ritual-v26.webp",imageAlt:"A woman applying cream while holding IQON Copper Peptide Restore Cream"},
