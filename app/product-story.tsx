...
export function ProductStory({product:p,products}:{product:Product;products:Product[]}) {
 ...
 const comparison=comparisonFor(p,products);const photo=p.images?.[1]||{src:p.image,alt:p.name};
 return <>
